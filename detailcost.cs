...
namespace AKUNTING
{
    public partial class detailcost : Form
    {
        public detailcost()
        {
            InitializeComponent();
        ...
        public void loaddata()
        {
            ...
            ncom.CommandText = "select faktur_no, costdid, keterangan,tanggalfaktur from namespace2.detailcosts";
        ...
        public void simpan()
        {
            ...
            NpgsqlConnection ncon = new NpgsqlConnection(stringkoneksi.connection);
            string masukdata = "insert into namespace2.DETAILCOSTS values(@faktur_no,@costdid,@keterangan,@scanfakturpath,@scanfaktur,@tanggalfaktur,@pathftp)";
            NpgsqlCommand ncom = new NpgsqlCommand(masukdata, ncon);
            ncom.Parameters.Add(new NpgsqlParameter("@faktur_no", txtnofaktur.Text));
            ncom.Parameters.Add(new NpgsqlParameter("@costdid", Convert.ToDecimal(this.txtaccountid.Text)));
        ...
        private void detailcost_Load(object sender, EventArgs e)
        {//C:\Users\Acer\Documents\Visual Studio 2015\Projects\AKUNTING VERSI 1.0\AKUNTING\Resources\nopicture1.jpg
            //a();
            loaddata();
        }
