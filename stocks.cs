    ...
    public partial class stocks : Form
    {
        ...
        private void ExportDataSetToExcelpenerimabeasiswa(DataSet ds, string strPath)
        {
            ...
            try
            {
                ...
                //Create Excel File
                strPath += @"\Rekap Stocks" + " " + DateTime.Now.ToString("dd MM yyyy") + ".xlsx";
                ...
                foreach (DataTable dtbl in ds.Tables)
                {
                    ...
                    excelWorkSheet.Cells[1, 1] = "Laporan Stocks";
        ...
        public void loaddata()
        {
            ...
            ncom.CommandText = "select*from namespace2.account_stocks";
        ...
        public void counts()
        {
            ...
            var sql = "select sum(amount)  from namespace2.account_stocks";
            ...
            while (dr.Read())
            {
                if (!dr.IsDBNull(0))
                {
                    jmlstocks = dr.GetInt32(0);
                    lbjmlstocks.Text = jmlstocks.ToString("N0", new CultureInfo("en-US"));
