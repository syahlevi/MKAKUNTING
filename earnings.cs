    ...
    public partial class earnings : Form
    {
        ...
        private void ExportDataSetToExcelpenerimabeasiswa(DataSet ds, string strPath)
        {
            ...
            try
            {
                ...
                //Create Excel File
                strPath += @"\Rekap Earnings" + " " + DateTime.Now.ToString("dd MM yyyy") + ".xlsx";
                ...
                foreach (DataTable dtbl in ds.Tables)
                {
                    ...
                    excelWorkSheet.Cells[1, 1] = "Laporan Earnings";
        ...
        public void countss()
        {
            ...
            var sql = "select sum(amount)  from namespace2.account_earnings";
        ...
        public void loaddata()
        {
            ...
            ncom.CommandText = "select*from namespace2.account_earnings";
